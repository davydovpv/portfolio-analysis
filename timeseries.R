...
convert.to.ts.with.sma <- function(closing.prices, fast=50, slow=200) {
...
plot.timeseries.with.sma <- function(closing.prices, stock.symbol, fast=50, slow=200) {
  stock.ts <- convert.to.ts.with.sma(closing.prices, fast, slow)
